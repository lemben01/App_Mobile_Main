...
import ca.qc.cstj.s09navigationdrawer.presentation.ui.element.ElementsViewModel
...
class FunFragment : Fragment(R.layout.fragment_fun){
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        try {
            /*val videoUri = Uri.parse("android.resource://${requireActivity().packageName}/${R.raw.}")
